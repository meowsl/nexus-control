...
Краткая инструкция, чтобы за 5 минут открыть TUI и прогнать сценарий download → scan → verify.
...
| `d` | ассеты | скачать выбранное |
| `s` | ассеты | скачать + scan |
| `v` | ассеты | скачать + scan + verify |
| `D` / `S` / `V` | ассеты | то же для **всего** репозитория |
